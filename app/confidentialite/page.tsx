    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Données collectées</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Finalité du traitement</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Hébergement des données</h2>
          <p className="text-[#334155] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Durée de conservation</h2>
          <p className="text-[#334155] leading-relaxed">
            Vos données sont conservées aussi longtemps que votre compte est actif. Elles sont supprimées sur simple demande à <a href="mailto:contact@maimoo.fr" className="text-[#3B5BDB] hover:underline">contact@maimoo.fr</a>. En cas d&apos;inactivité prolongée, nous nous réservons le droit de supprimer les données après un préavis par email.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Vos droits</h2>
          ...
          <p className="text-[#334155] mt-3">
            Pour exercer ces droits, contactez-nous à <a href="mailto:contact@maimoo.fr" className="text-[#3B5BDB] hover:underline">contact@maimoo.fr</a>.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Partage des données</h2>
          <p className="text-[#334155] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-[#1E2761] mb-3">Cookies</h2>
          <p className="text-[#334155] leading-relaxed">
