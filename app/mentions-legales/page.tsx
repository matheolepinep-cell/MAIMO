    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#0A0A0A] mb-3">Éditeur du site</h2>
          <p className="text-[#334155] leading-relaxed">
            <strong>Maimoo</strong><br />
            Représentant : Mathéo Lépine<br />
            63 avenue Raymond Poincaré<br />
            75016 Paris, France<br />
            Email : <a href="mailto:contact@maimoo.fr" className="text-[#0A0A0A] hover:underline">contact@maimoo.fr</a>
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#0A0A0A] mb-3">Directeur de la publication</h2>
          <p className="text-[#334155] leading-relaxed">Mathéo Lépine</p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#0A0A0A] mb-3">Hébergeur</h2>
          <p className="text-[#334155] leading-relaxed">
            <strong>Vercel Inc.</strong><br />
            340 Pine Street, Suite 701<br />
            San Francisco, CA 94104<br />
            États-Unis<br />
            <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-[#0A0A0A] hover:underline">vercel.com</a>
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-lg font-bold text-[#0A0A0A] mb-3">Propriété intellectuelle</h2>
          <p className="text-[#334155] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-[#0A0A0A] mb-3">Responsabilité</h2>
          <p className="text-[#334155] leading-relaxed">
