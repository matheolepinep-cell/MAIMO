    ...
    <div className="min-h-screen bg-[#F0F4FF] overflow-x-hidden">
      ...
      <section className="px-6 pt-16 pb-20 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link href="/login" className="flex items-center gap-2 px-6 py-3 rounded-2xl text-base font-semibold text-[#1E2761] bg-white border border-slate-200 hover:border-[#1E2761]/30 transition-all duration-200">
            Se connecter
          </Link>
        </div>
      </section>
