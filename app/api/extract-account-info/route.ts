...
Réponds UNIQUEMENT avec un objet JSON valide. Si une information n'est pas présente, omets le champ.
N'invente jamais d'informations. Extrait uniquement ce qui est explicitement mentionné.`,
    messages: [
      {
        role: 'user',
